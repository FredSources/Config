...
PS1='\[\033[01;33m\][`git branch 2>/dev/null|cut -f2 -d\* -s` ]`sudo -v -n 2>/dev/null && echo "\[\033[00m\]\[\033[05;41m\]" || echo "\[\033[01;32m\]"`\u\[\033[00;35m\]@\[\033[00;36m\]\h\[\033[01m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
